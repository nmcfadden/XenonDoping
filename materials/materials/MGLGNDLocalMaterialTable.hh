 ...
 *
 * CLASS DECLARATION:  MGLGNDLocalMaterialTable.hh
 *
 *---------------------------------------------------------------------------//
 *
 * DESCRIPTION:

 * This class build materials for the LGND simulations of MaGe. The materais
 ...
 * materials for LGND-related simulations.
 *
 * R. Henning 7/6/13
 */
//
 ...
 * REVISION:
 *
 * 07-06-2013, Created R. Henning
 * 07-11-17, Duplicated from MJ materials table for LGND, M. Green
 */
// --------------------------------------------------------------------------//

#ifndef _MGLGNDLOCALMATERIALTABLE_HH
#define _MGLGNDLOCALMATERIALTABLE_HH
...
class MGLGNDLocalMaterialTable
{
public:

  MGLGNDLocalMaterialTable();
  ~MGLGNDLocalMaterialTable();
