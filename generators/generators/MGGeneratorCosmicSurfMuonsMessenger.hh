...
#ifndef MGGeneratorCosmicSurfMuonsMessenger_h
#define MGGeneratorCosmicSurfMuonsMessenger_h 1

#include "G4UImessenger.hh"
#include "globals.hh"

class MGGeneratorCosmicSurfMuons;
...
class MGGeneratorCosmicSurfMuonsMessenger: public G4UImessenger {
  
public:
  MGGeneratorCosmicSurfMuonsMessenger(MGGeneratorCosmicSurfMuons *fPtclGun);
  ~MGGeneratorCosmicSurfMuonsMessenger();
  
  void SetNewValue(G4UIcommand *command, G4String newValues);
 
  
private:
  MGGeneratorCosmicSurfMuons *fParticleGun;
