...
G4INSTALL="/auto/common/majorana/simu/geant4.7.1.p01/src/geant4"
else
G4INSTALL="/auto/common/majorana/simu/geant4.7.1.p01"
fi
export G4INSTALL
if [ X$g4non_display = X ] ; then
...
if [ Xy != Xn ] ; then 
if [ X/auto/common/majorana/simu/geant4.7.1.p01 != X/auto/common/majorana/simu/geant4.7.1.p01 ] ; then
G4INCLUDE="/auto/common/majorana/simu/geant4.7.1.p01/include/geant4"
else
G4INCLUDE="/auto/common/majorana/simu/geant4.7.1.p01/include/"
fi
export G4INCLUDE
if [ X$g4non_display = X ] ; then
...
#else
#G4BASE="/auto/common/majorana/simu/geant4.7.1.p01/include/geant4/source"
#export G4BASE
#if [ X$g4non_display = X ] ; then
...
if [ X/auto/common/majorana/simu/geant4.7.1.p01 != X/auto/common/majorana/simu/geant4.7.1.p01 ] ; then
G4LIB="/auto/common/majorana/simu/geant4.7.1.p01/lib/geant4"
else
G4LIB="/auto/common/majorana/simu/geant4.7.1.p01/lib"
fi
export G4LIB
if [ X$g4non_display = X ] ; then
...
G4LEVELGAMMADATA="/auto/common/majorana/simu/geant4.7.1.p01/data/PhotonEvaporation"
...
G4RADIOACTIVEDATA="/auto/common/majorana/simu/geant4.7.1.p01/data/RadiativeDecay"
...
G4LEDATA="/auto/common/majorana/simu/geant4.7.1.p01/data/G4EMLOW3.0"
export G4LEDATA
if [ X$g4non_display = X ] ; then
...
NeutronHPCrossSections="/auto/common/majorana/simu/geant4.7.1.p01/data/G4NDL3.7"
...
G4ELASTICDATA="/auto/common/majorana/simu/geant4.7.1.p01/data/G4ELASTIC1.1"
