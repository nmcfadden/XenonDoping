...
#
#+
if ( X/auto/common/majorana/simu/geant4.7.0 != X/auto/common/majorana/simu/geant4.7.0 ) then
setenv G4INSTALL "/auto/common/majorana/simu/geant4.7.0/src/geant4"
##echo "On this machine the G4INSTALL=$G4INSTALL"
else
setenv G4INSTALL "/auto/common/majorana/simu/geant4.7.0"
##echo "On this machine the G4INSTALL=$G4INSTALL"
endif
...
if ( Xy != Xn ) then
if ( X/auto/common/majorana/simu/geant4.7.0 != X/auto/common/majorana/simu/geant4.7.0 ) then
setenv G4INCLUDE "/auto/common/majorana/simu/geant4.7.0/include/geant4"
else
setenv G4INCLUDE "/auto/common/majorana/simu/geant4.7.0/include"
endif
##echo "On this machine the G4INCLUDE=$G4INCLUDE"
#else
#setenv G4BASE "/auto/common/majorana/simu/geant4.7.0/include/geant4/source"
#echo "On this machine the G4BASE=$G4BASE"
endif

#+
if ( X/auto/common/majorana/simu/geant4.7.0/lib != X ) then
if ( X/auto/common/majorana/simu/geant4.7.0 != X/auto/common/majorana/simu/geant4.7.0 ) then
setenv G4LIB "/auto/common/majorana/simu/geant4.7.0/lib/geant4"
else
setenv G4LIB "/auto/common/majorana/simu/geant4.7.0/lib"
endif
##echo "On this machine the G4LIB=$G4LIB"
endif

#+
if ( X/auto/common/majorana/simu/geant4.7.0/data/PhotonEvaporation != X ) then
setenv G4LEVELGAMMADATA "/auto/common/majorana/simu/geant4.7.0/data/PhotonEvaporation"
##echo "On this machine the G4LEVELGAMMADATA=$G4LEVELGAMMADATA"
endif

#+
if ( X/auto/common/majorana/simu/geant4.7.0/data/RadiativeDecay != X ) then
setenv G4RADIOACTIVEDATA "/auto/common/majorana/simu/geant4.7.0/data/RadiativeDecay"
##echo "On this machine the G4RADIOACTIVEDATA=$G4RADIOACTIVEDATA"
endif

#+
if ( X/auto/common/majorana/simu/geant4.7.0/data/G4EMLOW2.3 != X ) then
setenv G4LEDATA "/auto/common/majorana/simu/geant4.7.0/data/G4EMLOW2.3"
##echo "On this machine the G4LEDATA=$G4LEDATA"
endif

#+
if ( X/auto/common/majorana/simu/geant4.7.0/data/G4NDL3.7 != X ) then
setenv NeutronHPCrossSections "/auto/common/majorana/simu/geant4.7.0/data/G4NDL3.7"
##echo "On this machine the NeutronHPCrossSections=$NeutronHPCrossSections"
endif

#+
if ( X/auto/common/majorana/simu/geant4.7.0/data/Elastic != X ) then
setenv G4ELASTICDATA "/auto/common/majorana/simu/geant4.7.0/data/Elastic"
