...
#ifndef _MGEPVDETECTORMESSENGER_HH
#define _MGEPVDETECTORMESSENGER_HH
...
class MGEPVDetectorMessenger : public G4UImessenger
{

public:

  //default constructor
  MGEPVDetectorMessenger(MGEPVDetector*);

  // destructor
  ~MGEPVDetectorMessenger();
...
private:
  ...
  MGEPVDetector* fDetectorPointer; 
