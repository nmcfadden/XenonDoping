...
//---------------------------------------------------------------------------//
/**                                                            
 * $Id: MGSORDetector.hh,v 1.0 2010-04-06 14:22:00 matthiasl Exp $
 *      
 * CLASS DECLARATION:  MGSORDetector.hh
 *
 *---------------------------------------------------------------------------//
 *
 * DESCRIPTION: 
 * Geometry class for the MGSOR detector at LNGS 
 *
 * REVISION:
 *
...
#ifndef _MGSORDETECTOR_HH
#define _MGSORDETECTOR_HH
...
class MGSORDetectorMessenger;
class G4Material;

class MGSORDetector : public MGGeometryDetector
{
...
private:
  ...
  */
  ...
  MGSORDetectorMessenger* theMessenger;
