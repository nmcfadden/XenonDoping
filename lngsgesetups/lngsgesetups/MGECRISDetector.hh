...
//---------------------------------------------------------------------------//
/**                                                            
 * $Id: MGECRISDetector.hh,v 1.0 2010-04-06 14:22:00 matthiasl Exp $
 *      
 * CLASS DECLARATION:  MGECRISDetector.hh
 *
 *---------------------------------------------------------------------------//
 *
 * DESCRIPTION: 
 * Geometry class for the GECRIS detector at LNGS 
 *
 * REVISION:
 *
...
#ifndef _MGECRISDETECTOR_HH
#define _MGECRISDETECTOR_HH
...
class MGECRISDetectorMessenger;
class G4Material;

class MGECRISDetector : public MGGeometryDetector
{
public:
...
private:
  ...
  */
  ...
  MGECRISDetectorMessenger* theMessenger;
};
