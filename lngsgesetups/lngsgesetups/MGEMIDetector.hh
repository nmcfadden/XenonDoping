...
//---------------------------------------------------------------------------//
/**                                                            
 * $Id: MGEMIDetector.hh,v 1.0 2010-04-06 14:22:00 matthiasl Exp $
 *      
 * CLASS DECLARATION:  MGEMIDetector.hh
 *
 *---------------------------------------------------------------------------//
 *
 * DESCRIPTION: 
 * Geometry class for the MGEMI detector at LNGS 
 *
 * REVISION:
 *
 * 04-08-2010, Added in MaGe, Luciano
 *
 */
// --------------------------------------------------------------------------//

#ifndef _MGEMIDETECTOR_HH
#define _MGEMIDETECTOR_HH
...
class MGEMIDetectorMessenger;
class G4Material;

class MGEMIDetector : public MGGeometryDetector
{
...
private:
  ...
  */
  ...
  MGEMIDetectorMessenger* theMessenger;
