...
#ifndef _MGSORDETECTORMESSENGER_HH
#define _MGSORDETECTORMESSENGER_HH
...
class MGSORDetectorMessenger : public G4UImessenger
{
public:

  //default constructor
  MGSORDetectorMessenger(MGSORDetector*);

  // destructor
  ~MGSORDetectorMessenger();
...
private:
  ...
  MGSORDetector* fDetectorPointer; 
