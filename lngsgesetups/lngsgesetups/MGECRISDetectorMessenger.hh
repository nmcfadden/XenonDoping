...
#ifndef _MGECRISDETECTORMESSENGER_HH
#define _MGECRISDETECTORMESSENGER_HH
...
class MGECRISDetectorMessenger : public G4UImessenger
{

public:

  //default constructor
  MGECRISDetectorMessenger(MGECRISDetector*);

  // destructor
  ~MGECRISDetectorMessenger();
...
private:
  ...
  MGECRISDetector* fDetectorPointer; 
