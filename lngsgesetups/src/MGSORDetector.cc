...
//---------------------------------------------------------------------------//
//                                                          
// $Id: MGSORDetector.cc,v 1.1 2010-03-04 16:39:00 matthiasl Exp $ 
//      
// CLASS IMPLEMENTATION: MGSORDetector
//
//---------------------------------------------------------------------------//
/**
 * SPECIAL NOTES:
...
#include "lngsgesetups/MGSORDetectorMessenger.hh"

using namespace CLHEP;

//---------------------------------------------------------------------------//

MGSORDetector::MGSORDetector() : MGGeometryDetector("")
{
  //set defaults
  ...
  */
  ...
  crystal_d=7.84*cm;
  crystal_l=8.46*cm;
  theMessenger = new MGSORDetectorMessenger(this);
}

//---------------------------------------------------------------------------//

MGSORDetector::~MGSORDetector()
{
  delete theMessenger;
}
...
void MGSORDetector::ConstructDetector()
{
  ...
  */  
  ...
  // --- Cryostat
  // ------------------------------------------------------------------------------
  // --- endcap window (GsOr D95.3)
  
  G4Tubs* detwindow_tubs = new G4Tubs("detwindow_tubs", 0, 4.615*cm, 0.075*cm, 0, twopi);
  ...
  G4Tubs* dethousing_tubs = new G4Tubs("dethousing_tubs", 4.615*cm, 4.765*cm, 7.25*cm, 0, twopi);
  ...
  G4Tubs* dethousingclad_tubs = new G4Tubs("dethousingclad_tubs", 
					   4.59*cm, 4.615*cm, 6.775*cm, 0, twopi);
  ...
  G4Tubs* detinnercap_tubs = new G4Tubs("detinnercap_tubs", 
					crystal_d/2+0.005*cm, crystal_d/2+0.055*cm, 
					6.255*cm, 0, twopi);
  ...
  new G4PVPlacement(0, G4ThreeVector(0., 0., 0.92*cm-d_z), 
  ...
  new G4PVPlacement(0, G4ThreeVector(0., 0., -5.5*cm-d_z), 
  ...
  G4Tubs* detinnercapring_tubs = new G4Tubs("detinnercapring_tubs", 
					    crystal_d/2+0.055*cm, crystal_d/2+0.255*cm, 
					    0.3*cm, 0, twopi);
  ...
  new G4PVPlacement(0, G4ThreeVector(0., 0., 7.17725*cm-d_z), 
  ...
  new G4PVPlacement(0, G4ThreeVector(0., 0., 7.17975*cm-d_z), 
  ...
  G4Tubs* detpecap_tubs = new G4Tubs("detpecap_tubs", 
				     crystal_d/2+0.505*cm,  crystal_d/2+0.605*cm, 
				     0.4*cm, 0, twopi);
  ...
  new G4PVPlacement(0, G4ThreeVector(0., 0., 6.73*cm-d_z), 
  ...
  G4Tubs* detpecaptop_tubs = new G4Tubs("detpecaptop_tubs", 
					crystal_d/2.+0.205*cm,  crystal_d/2.+0.605*cm, 
					0.05*cm, 0, twopi);
  ...
  new G4PVPlacement(0, G4ThreeVector(0., 0., 7.23*cm-d_z), 
  ...
  G4Tubs* detholeincrystal_tubs = new G4Tubs("detholeincrystal_tubs", 0., 
					     hole_d/2, hole_l/2-hole_d/4, 0, twopi);
  G4Sphere* detholeincrystal_bullet = new G4Sphere("detholeincrystal_bullet", 
						   0., hole_d/2, 0, twopi, 0, twopi/4);

  G4VSolid* dethole_shape=0;
  dethole_shape   = new G4UnionSolid("dethole_shape", detholeincrystal_tubs, 
				     detholeincrystal_bullet, 0, 
				     G4ThreeVector (0.,0.,hole_l/2-hole_d/4));
  ...
  new G4PVPlacement(0, G4ThreeVector(0, 0, -(crystal_l/2-d_dead/2)+hole_l/2), 
		    dethole_log,
		    "dethole", crystal_log, false, 0);

  /* --- hole in dead layer -----------------------------------
  
  G4Tubs* detholeindeadlayer_tubs = new G4Tubs("detholeindeadlayer_tubs", 
  0., 0.55*cm, d_dead/2, 0, twopi);
  ...
  */
  ...
  if (G4Material::GetMaterial(sample_mat_name))
  ...
  else 
    {
      ...
      G4Exception("MGSORDetector::ConstructDetector()","err001",FatalException,"Exit MaGe");
    }
  ...
  if (sample_geom=="smarinelli")
    {
      ...
      // ----------------------------------------- Cu block in nitrogen filled chamber, true value half height: 2.85 cm

      G4Box* Cublock_box
	= new G4Box("Cublock_box", 8.0*cm, 8.0*cm, 2.8*cm);

      // ----------------------------------------- drilled hole in Cu block in nitrogen filled chamber

      G4Tubs* drhole_tubs
	= new G4Tubs("drhole_tubs", 0., 5.0*cm, 2.8*cm, 0, twopi);
	...
	= new G4LogicalVolume(Cu_shield, Cu, "Cu_shield_log", 0, 0, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, -8.8*cm), Cu_shield_log,
	...
	= new G4LogicalVolume(marinellis1l_tubs, PE, "marinellis1l_tubs_log", 0, 0, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, -5.9*cm), marinellis1l_tubs_log, "marinellis1l_tubs", 
	...
	= new G4LogicalVolume(marinellis1o_tubs, PE, "marinellis1o_tubs_log", 0, 0, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, -1.9*cm), marinellis1o_tubs_log, "marinellis1o_tubs", 
			Nfilledchamber_log, false, 0);
	...
	= new G4LogicalVolume(marinellis2o_cons, PE, "marinellis2o_cons_log", 0, 0, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, 6.3*cm), marinellis2o_cons_log, "marinellis2o_cons", 
			Nfilledchamber_log, false, 0);
	...
	= new G4LogicalVolume(marinellis1i_cons, PE, "marinellis1i_cons_log", 0, 0, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, -0.725*cm), marinellis1i_cons_log, "marinellis1i_cons", 
			Nfilledchamber_log, false, 0);
	...
	= new G4LogicalVolume(marinellis2l_tubs, PE, "marinellis2l_tubs_log", 0, 0, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, 4.275*cm), marinellis2l_tubs_log, "marinellis2l_tubs", 
			Nfilledchamber_log, false, 0);
	...
	= new G4LogicalVolume(marinellis3l_tubs, PE, "marinellis3l_tubs_log", 0, 0, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, 10.7*cm), marinellis3l_tubs_log, "marinellis3l_tubs", 
			Nfilledchamber_log, false, 0);
      ...
      if ((fillingheight>=0*cm) && (fillingheight<=7.8*cm))
	{
	  ...
	  new G4PVPlacement(0, G4ThreeVector(0, 0, (-5.8*cm+sampleheight)), sample_log,
      ...
      else if ((fillingheight>7.8*cm) && (fillingheight<=10.15*cm))
	{
	  ...
	  G4LogicalVolume* sample_log
	    = new G4LogicalVolume(sample_shape, sample_mat, "sample_log", 0, 0, 0);
	  sample_log -> SetVisAttributes(Sample_Colour);
	  new G4PVPlacement(0, G4ThreeVector(0, 0, -1.9*cm), sample_log,
			    "sample", Nfilledchamber_log, false, 0);
	}
      ...
      else
	{
	  ...
	  G4Exception("MGSORDetector::ConstructDetector()","err002",FatalException,"Check the value");
	  MGLog(fatal) << endlog;
	}
    }
	...
	= new G4LogicalVolume(Cu_shield, Cu, "Cu_shield_log", 0, 0, 0);
      ...
      G4Tubs* sample_holder_tubs = new G4Tubs("sample_holder_tubs", 4.8*cm, 5.0*cm, 2.215*cm, 0, twopi);
	...
	= new G4LogicalVolume(sample_holder_tubs, Acrylic, "sample_holder_log", 0, 0, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0., 0., 5.415*cm), sample_holder_log, "sample_holder",
			Nfilledchamber_log, false, 0);

      // --- Acrylic support ring of sample holder 0.24 cm thickness

      G4Tubs* sample_holder_ring_tubs = new G4Tubs("sample_holder_ring_tubs", 4.56*cm, 4.8*cm, 0.12*cm, 0, twopi);
	...
	= new G4LogicalVolume(sample_holder_ring_tubs, Acrylic, "sample_holder_ring_log", 0, 0, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0., 0., 3.32*cm), sample_holder_ring_log, "sample_holder_ring",
			Nfilledchamber_log, false, 0);

      // --- support ring in sample holder is 0.54 cm from detector window
	...
	= new G4LogicalVolume(supportring_tubs, Acrylic, "supportring_log", 0, 0, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0., 0., 3.44*cm+h_sring/2.), supportring_log, "supportring",
			Nfilledchamber_log, false, 0);
	...
	= new G4LogicalVolume(detplasticbottom_tubs, PS, "detplasticbottom_log", 0, 0, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(s_x, s_y, s_z+3.44*cm+h_sring+0.05*cm), detplasticbottom_log, 
	...
	= new G4LogicalVolume(detplasticcap_tubs, PS, "detplasticcap_log", 0, 0, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(s_x, s_y, s_z+3.44*cm+h_sring+h_sbox+0.15*cm), detplasticcap_log, 
			"detplasticcap", Nfilledchamber_log, false, 0);
	...
	= new G4LogicalVolume(detplasticshell_tubs, PS, "detplasticshell_log", 0, 0, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(s_x, s_y, s_z+3.44*cm+h_sring+h_sbox/2.+0.1*cm), 
      ...
      new G4PVPlacement(0, G4ThreeVector(s_x, s_y, 3.44*cm+h_sring+tube_length/2.+0.1*cm), 
	...
	= new G4LogicalVolume(Cu_shield, Cu, "Cu_shield_log", 0, 0, 0);
      ...
      */
      ...
      //position : touching detector window; on bottom of the Chamber
      new G4PVPlacement(halfPi_x_rot, G4ThreeVector(0., s_y-5.65*cm, 13.025*cm), NPLbottle_log, "NPLbottle", 
			Nfilledchamber_log, false, 0);



      //contents :
      G4Tubs* NPLbottleN2_tubs = new G4Tubs("NPLbottleN2_tubs", 0., 2.175*cm, 
					    4.25*cm-tube_length/2, 0, twopi);    //filled with N2 of the chamber (?)

      G4LogicalVolume* NPLbottleN2_log = new G4LogicalVolume(NPLbottleN2_tubs, N2Gas, "NPLbottleN2_log", 0, 0, 0);
      NPLbottleN2_log -> SetVisAttributes(N2Gascolour);

      new G4PVPlacement(0, G4ThreeVector(0., 0., tube_length/2-0.05*cm), NPLbottleN2_log, 
			"NPLbottleN2", NPLbottle_log, false, 0);


      //needs to change macro confine volume ---> NPLsample
      G4Tubs* NPLsample_tubs = new G4Tubs("NPLsample_tubs", 0.,  2.175*cm, tube_length/2, 0, twopi);

      G4LogicalVolume* NPLsample_log = new G4LogicalVolume(NPLsample_tubs, sample_mat, 
							   "NPLsample_log", 0, 0, 0);
      NPLsample_log -> SetVisAttributes(Sample_Colour);

      new G4PVPlacement(0, G4ThreeVector(0., 0., tube_length/2-4.3*cm), NPLsample_log, 
			"NPLsample", NPLbottle_log, false, 0);
  ...
  else   
    {
      ...
      G4cout << "\n\n" << sample_geom << "\n\n";
      MGLog(fatal) << endlog;
      G4Exception("MGSORDetector::ConstructDetector()","err003",FatalException,"Check the shape type");
    }
