...
//---------------------------------------------------------------------------//
//                                                          
// $Id: MGSORDetectorMessenger.cc,v 1.0 2010-02-26 18:06:00 matthiasl Exp $ 
//      
// CLASS IMPLEMENTATION:  MGSORDetectorMessenger.cc
...
MGSORDetectorMessenger::MGSORDetectorMessenger(MGSORDetector *dete) :
  fDetectorPointer(dete) 
{
  // directories 
  fDetectorDir =  new G4UIdirectory("/MG/geometry/mgsor/"); 
  fDetectorDir -> SetGuidance("Tune sample parameter for MGSOR detector"); 
  
  fSampleTypeCmd =  new G4UIcmdWithAString("/MG/geometry/mgsor/sample", this);
  ...
  fSampleMaterialCmd =  new G4UIcmdWithAString("/MG/geometry/mgsor/samplematerial", this);
  ...
  fSMarinelliHeightCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/smarinelliheight", this);
  ...
  fSBoxHeightCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/sboxheight", this);
  ...
  fSBoxIDiameterCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/sboxinnerd", this);
  ...
  fSBoxODiameterCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/sboxouterd", this);
  ...
  fSupportHeightCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/supportheight", this);
  ...
  fSupportIDiameterCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/supportinnerd", this);
  ...
  fSupportODiameterCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/supportouterd", this);
  ...
  fBoxHeightCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/boxheight", this);
  ...
  fBoxWidthCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/boxwidth", this);
  ...
  fBoxThicknessCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/boxthickness", this);
  ...
  fTubeInnerRadiusCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/tubeinnerradius", this);
  ...
  fTubeOuterRadiusCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/tubeouterradius", this);
  ...
  fTubeLengthCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/tubelength", this);
  ...
  fSamplexposCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/samplexpos", this);
  ...
  fSampleyposCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/sampleypos", this);
  ...
  fSamplezposCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/samplezpos", this);
  ...
  fDetzposCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/detzpos", this);
  ...
  fDeadThicknessCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/deadthickness", this);
  ...
  fHoleDiameterCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/holediameter", this);
  fHoleDiameterCmd -> SetGuidance("Set hole diameter (including dead layer)");
  fHoleDiameterCmd -> SetParameterName("HoleDiameter", true); 
  fHoleDiameterCmd -> SetDefaultValue(0.94);
  fHoleDiameterCmd -> SetDefaultUnit("cm"); 

  fHoleLengthCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/holelength", this);
  fHoleLengthCmd -> SetGuidance("Set hole length (including dead layer)");
  fHoleLengthCmd -> SetParameterName("HoleLength", true); 
  fHoleLengthCmd -> SetDefaultValue(7.1);
  fHoleLengthCmd -> SetDefaultUnit("cm"); 

  fDetDiameterCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/detdiameter", this);
  ...
  fDetDiameterCmd -> SetDefaultValue(7.84);
  fDetDiameterCmd -> SetDefaultUnit("cm"); 

  fDetLengthCmd =  new G4UIcmdWithADoubleAndUnit("/MG/geometry/mgsor/detlength", this);
  fDetLengthCmd -> SetGuidance("Set crystal length (including dead layer)");
  fDetLengthCmd -> SetParameterName("DetLength", true); 
  fDetLengthCmd -> SetDefaultValue(8.46);
...
MGSORDetectorMessenger::~MGSORDetectorMessenger()
{
...
void MGSORDetectorMessenger::SetNewValue(G4UIcommand *cmd, G4String newvalue)
{
