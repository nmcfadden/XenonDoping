 ...
 *      
 * CLASS DECLARATION:  MJDemoJSONDet.hh
 *
 *---------------------------------------------------------------------------//
 *
 * DESCRIPTION: 
...
#ifndef _MJDEMOJASONDET_HH
#define _MJDEMOJASONDET_HH
...
class MJDemoJSONDet: public MJVDemoDetector
{
  
public:
  MJDemoJSONDet(G4String partName, G4String serialNumber);
  MJDemoJSONDet(const MJDemoJSONDet &);
  ~MJDemoJSONDet();
