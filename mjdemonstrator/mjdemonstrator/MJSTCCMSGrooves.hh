...
//                                                          
//      
// CLASS IMPLEMENTATION:  MJSTCCMSGrooves.hh
//
//---------------------------------------------------------------------------//
/**
 * SPECIAL NOTES:
...
//---------------------------------------------------------------------------//
#ifndef _MJSTCCMSGROOVES_HH
#define _MJSTCCMSGROOVES_HH
...
class MJSTCCMSGrooves: public MJVDemoPart
{
  
public:
  MJSTCCMSGrooves(G4String, G4String);
  MJSTCCMSGrooves(const MJSTCCMSGrooves &);
  ~MJSTCCMSGrooves();
