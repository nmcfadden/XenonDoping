 ...
 *      
 * CLASS DECLARATION:  MJDemoCalibrationTrack.hh
 *
 *---------------------------------------------------------------------------//
 *
 * DESCRIPTION: 
...
#ifndef _MJDEMOCALIBRATIONTRACK_HH
#define _MJDEMOCALIBRATIONTRACK_HH
...
class MJDemoCalibrationTrack: public MJVDemoPart
{
  
public:
  MJDemoCalibrationTrack(G4String partName, G4String serialNumber);
  MJDemoCalibrationTrack(const MJDemoCalibrationTrack &);
  ~MJDemoCalibrationTrack();
