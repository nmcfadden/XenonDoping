...
//                                                          
//      
// CLASS IMPLEMENTATION:  MJSTCColdPlateBody.hh
//
//---------------------------------------------------------------------------//
/**
 * SPECIAL NOTES:
...
//---------------------------------------------------------------------------//
#ifndef _MJSTCCOLDPLATEBODY_HH
#define _MJSTCCOLDPLATEBODY_HH
...
class MJSTCColdPlateBody: public MJVDemoPart
{
  
public:
  MJSTCColdPlateBody(G4String, G4String);
  MJSTCColdPlateBody(const MJSTCColdPlateBody &);
  ~MJSTCColdPlateBody();
