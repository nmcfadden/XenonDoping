 ...
 *      
 * CLASS DECLARATION:  MJDemo51624Bolt.hh
 *
 *---------------------------------------------------------------------------//
 *
 * DESCRIPTION: 
...
#ifndef _MJDEMO51624BOLT_HH
#define _MJDEMO51624BOLT_HH
...
class MJDemo51624Bolt: public MJVDemoPart
{
  
public:
  MJDemo51624Bolt(G4String partName, G4String serialNumber, 
					G4double length);
  MJDemo51624Bolt(const MJDemo51624Bolt &);
  ~MJDemo51624Bolt();
