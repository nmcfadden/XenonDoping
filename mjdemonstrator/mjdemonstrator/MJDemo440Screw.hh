 ...
 *      
 * CLASS DECLARATION:  MJDemo440Screw.hh
 *
 *---------------------------------------------------------------------------//
 *
 * DESCRIPTION: 
...
#ifndef _MJDEMO440SCREW_HH
#define _MJDEMO440SCREW_HH
...
class MJDemo440Screw: public MJVDemoPart
{
  
public:
  MJDemo440Screw(G4String partName, G4String serialNumber, 
					G4double length);
  MJDemo440Screw(const MJDemo440Screw &);
  ~MJDemo440Screw();
