...
//      
// CLASS IMPLEMENTATION:  MJDemoThermosyphonSupportThickHalfMale.cc
//
//---------------------------------------------------------------------------//
/**
 * SPECIAL NOTES:
...
MJDemoThermosyphonSupportThickHalfMale::MJDemoThermosyphonSupportThickHalfMale(G4String partName, G4String serialNumber) :
  MJVDemoPart(partName, serialNumber, "MJ80-11-140-R002", "Vespel")
{;}

MJDemoThermosyphonSupportThickHalfMale::MJDemoThermosyphonSupportThickHalfMale(const MJDemoThermosyphonSupportThickHalfMale & rhs) : 
  MJVDemoPart(rhs)
{;}

MJDemoThermosyphonSupportThickHalfMale::~MJDemoThermosyphonSupportThickHalfMale()
{;}

G4LogicalVolume* MJDemoThermosyphonSupportThickHalfMale::ConstructPart()
{
  ...
  if (pVol == NULL){
    ...
    G4Tubs* mainCyl = new G4Tubs("Main Cyl",33.274/2*mm, 70.18/2*mm, 6.35/2*mm, M_PI, M_PI);
    ...
    MGLog(debugging) << "Created Thermosyphon Support Thick Male Half With Slotted Cable Holes Logical" << endlog;
  }
  else  MGLog(debugging) << "Using pre-existing Thermosyphon Support Thick Male Half With Slotted Cable Holes Logical" << endlog;
  return pVol;
}  
