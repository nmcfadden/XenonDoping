...
MJDemoPoly_Panel9::MJDemoPoly_Panel9(G4String partName, G4String serialNumber) :
  MJVDemoPart(partName, serialNumber, "PolyNorthWall_SmallOuterUpper", serialNumber)
{;}

MJDemoPoly_Panel9::MJDemoPoly_Panel9(const MJDemoPoly_Panel9 & rhs) : 
  MJVDemoPart(rhs)
{;}

MJDemoPoly_Panel9::~MJDemoPoly_Panel9()
{;}

G4LogicalVolume* MJDemoPoly_Panel9::ConstructPart()
{
  ...
  if (pVol == NULL){
		G4Box* poly_Panel9 = new G4Box("poly_Panel9", 819.15*mm, 25.4*mm, 381*mm);  //64.5 x (5x6)
	

    G4VisAttributes* greenVisAtt = new G4VisAttributes(G4Colour(0.0, 1.0, 0.0)); // green
    greenVisAtt->SetForceWireframe( false );
    G4Material *material = G4Material::GetMaterial(this->GetMaterial());
    pVol = new G4LogicalVolume(poly_Panel9, material, logicalName);
