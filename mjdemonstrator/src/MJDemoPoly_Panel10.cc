...
MJDemoPoly_Panel10::MJDemoPoly_Panel10(G4String partName, G4String serialNumber) :
  MJVDemoPart(partName, serialNumber, "PolyWestWall_SmallInnerLower", serialNumber)
{;}

MJDemoPoly_Panel10::MJDemoPoly_Panel10(const MJDemoPoly_Panel10 & rhs) : 
  MJVDemoPart(rhs)
{;}

MJDemoPoly_Panel10::~MJDemoPoly_Panel10()
{;}

G4LogicalVolume* MJDemoPoly_Panel10::ConstructPart()
{
  ...
  if (pVol == NULL){
		G4Box* poly_Panel10 = new G4Box("poly_Panel10", 25.4*mm, 701.675*mm, 787.4*mm);  // 55.25x62
	

    G4VisAttributes* greenVisAtt = new G4VisAttributes(G4Colour(0.0, 1.0, 0.0)); // green
    greenVisAtt->SetForceWireframe( false );
    G4Material *material = G4Material::GetMaterial(this->GetMaterial());
    pVol = new G4LogicalVolume(poly_Panel10, material, logicalName);
