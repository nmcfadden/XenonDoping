...
MJDemoPoly_Panel17::MJDemoPoly_Panel17(G4String partName, G4String serialNumber) :
  MJVDemoPart(partName, serialNumber, "PolyEastWall_ChillerInner", serialNumber)
{;}

MJDemoPoly_Panel17::MJDemoPoly_Panel17(const MJDemoPoly_Panel17 & rhs) : 
  MJVDemoPart(rhs)
{;}

MJDemoPoly_Panel17::~MJDemoPoly_Panel17()
{;}

G4LogicalVolume* MJDemoPoly_Panel17::ConstructPart()
{
  ...
  if (pVol == NULL){
	  ...
	  G4SubtractionSolid* box2 = new G4SubtractionSolid("box2", box1, cutout1, 0, G4ThreeVector(0, -258.953*mm, -680.72*mm));
		G4Box* cutout2 = new G4Box("cutout2",  25.5*mm, 154.178*mm, 149.225*mm);    	//12.14x11.75
    G4SubtractionSolid* box3 = new G4SubtractionSolid("box3", box2, cutout2, 0, G4ThreeVector(0, -210.185*mm, -200.787*mm));
		G4Box* cutout3 = new G4Box("cutout3", 25.5*mm, 101.6*mm, 50.8*mm);    	//8 x4 in 3rd panel from above
  	G4SubtractionSolid* poly_Panel17 = new G4SubtractionSolid("poly_Panel17", box3, cutout3, 0, G4ThreeVector(0, -266.573*mm, 787.4*mm));
	

    G4VisAttributes* greenVisAtt = new G4VisAttributes(G4Colour(0.0, 1.0, 0.0)); // green
    greenVisAtt->SetForceWireframe( false );
    G4Material *material = G4Material::GetMaterial(this->GetMaterial());
    pVol = new G4LogicalVolume(poly_Panel17, material, logicalName);
