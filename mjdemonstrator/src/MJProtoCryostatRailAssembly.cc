...
MJProtoCryostatRailAssembly::MJProtoCryostatRailAssembly(G4String fName, G4String serialNumber) :
  MJVDemoAssembly(fName, serialNumber, "CryostatRails")
{
  ...
  fBolt1Ptr = new MJProtoCryostatBolt(fName+"_Bolt_001", "867-5309");
  fBolt2Ptr = new MJProtoCryostatBolt(fName+"_Bolt_002", "867-5309");  
  fBolt3Ptr = new MJProtoCryostatBolt(fName+"_Bolt_003", "867-5309");  
  fBolt4Ptr = new MJProtoCryostatBolt(fName+"_Bolt_004", "867-5309");  
  fBolt5Ptr = new MJProtoCryostatBolt(fName+"_Bolt_005", "867-5309");  
  fBolt6Ptr = new MJProtoCryostatBolt(fName+"_Bolt_006", "867-5309");  
  fBolt7Ptr = new MJProtoCryostatBolt(fName+"_Bolt_007", "867-5309");  
  fBolt8Ptr = new MJProtoCryostatBolt(fName+"_Bolt_008", "867-5309");  
  fBolt9Ptr = new MJProtoCryostatBolt(fName+"_Bolt_009", "867-5309");  
  fBolt10Ptr = new MJProtoCryostatBolt(fName+"_Bolt_010", "867-5309");  
  fBolt11Ptr = new MJProtoCryostatBolt(fName+"_Bolt_011", "867-5309");  
  fBolt12Ptr = new MJProtoCryostatBolt(fName+"_Bolt_012", "867-5309");  
  fNut1Ptr = new MJProtoHVNut(fName+"_Nut_001", "867-5309");
  fNut2Ptr = new MJProtoHVNut(fName+"_Nut_002", "867-5309");
  fNut3Ptr = new MJProtoHVNut(fName+"_Nut_003", "867-5309");
  fNut4Ptr = new MJProtoHVNut(fName+"_Nut_004", "867-5309");
  fNut5Ptr = new MJProtoHVNut(fName+"_Nut_005", "867-5309");
  fNut6Ptr = new MJProtoHVNut(fName+"_Nut_006", "867-5309");
  fNut7Ptr = new MJProtoHVNut(fName+"_Nut_007", "867-5309");
  fNut8Ptr = new MJProtoHVNut(fName+"_Nut_008", "867-5309");
  fNut9Ptr = new MJProtoHVNut(fName+"_Nut_009", "867-5309");
  fNut10Ptr = new MJProtoHVNut(fName+"_Nut_010", "867-5309");
  fNut11Ptr = new MJProtoHVNut(fName+"_Nut_011", "867-5309");
  fNut12Ptr = new MJProtoHVNut(fName+"_Nut_012", "867-5309");
}

MJProtoCryostatRailAssembly::MJProtoCryostatRailAssembly(const MJProtoCryostatRailAssembly & rhs) : 
  MJVDemoAssembly(rhs)
{
  fCenterRail1Ptr = new MJDemoCryostatCenterRail(fName+"_CenterRail_001", "867-5309");
  fCenterRail2Ptr = new MJDemoCryostatCenterRail(fName+"_CenterRail_002", "867-5309");
...
MJProtoCryostatRailAssembly::~MJProtoCryostatRailAssembly()
{
...
void MJProtoCryostatRailAssembly::Place(G4ThreeVector* assemPosition, 
                G4RotationMatrix* assemRotation, G4LogicalVolume* motherLogical)
{
  ...
  *CenterRail4affine*=*assemAffine;  
  ...
  G4ThreeVector *LidRail1localPos = new G4ThreeVector(0, 0, 1.225*25.4*mm); //1.2248
  ...
  *LidRail1affine*=*assemAffine;  
  ...
  G4ThreeVector *LidRail2localPos = new G4ThreeVector(0, 0, 1.225*25.4*mm);
  ...
  *LidRail2affine*=*assemAffine;  
  ...
  G4ThreeVector *LidRail3localPos = new G4ThreeVector(0, 0, 1.225*25.4*mm);
  ...
  *LidRail3affine*=*assemAffine;  
  ...
  G4ThreeVector *LidRail4localPos = new G4ThreeVector(0, 0, 1.225*25.4*mm);
  ...
  *Bolt12affine*=*assemAffine;  
  ...
  G4ThreeVector *Nut1localPos = new G4ThreeVector(boltRad*cos(0.5*boltangle), 
  													boltRad*sin(0.5*boltangle), 1.2258*25.4*mm);//1.2248
  ...
  *Nut1affine*=*assemAffine;  
  ...
  G4ThreeVector *Nut2localPos = new G4ThreeVector(boltRad*cos(1.5*boltangle), 
  													boltRad*sin(1.5*boltangle), 1.2258*25.4*mm);
  ...
  *Nut2affine*=*assemAffine;  
  ...
  G4ThreeVector *Nut3localPos = new G4ThreeVector(boltRad*cos(2.5*boltangle), 
  													boltRad*sin(2.5*boltangle), 1.2258*25.4*mm);
  ...
  *Nut3affine*=*assemAffine;  
  ...
  G4ThreeVector *Nut4localPos = new G4ThreeVector(boltRad*cos(3.5*boltangle), 
  													boltRad*sin(3.5*boltangle), 1.2258*25.4*mm);
  ...
  *Nut4affine*=*assemAffine;  
  ...
  G4ThreeVector *Nut5localPos = new G4ThreeVector(boltRad*cos(4.5*boltangle), 
  													boltRad*sin(4.5*boltangle), 1.2258*25.4*mm);
  ...
  *Nut5affine*=*assemAffine;  
  ...
  G4ThreeVector *Nut6localPos = new G4ThreeVector(boltRad*cos(5.5*boltangle), 
  													boltRad*sin(5.5*boltangle), 1.2258*25.4*mm);
  ...
  *Nut6affine*=*assemAffine;  
  ...
  G4ThreeVector *Nut7localPos = new G4ThreeVector(boltRad*cos(6.5*boltangle), 
  													boltRad*sin(6.5*boltangle), 1.2258*25.4*mm);
  ...
  *Nut7affine*=*assemAffine;  
  ...
  G4ThreeVector *Nut8localPos = new G4ThreeVector(boltRad*cos(7.5*boltangle), 
  													boltRad*sin(7.5*boltangle), 1.2258*25.4*mm);
  ...
  *Nut8affine*=*assemAffine;  
  ...
  G4ThreeVector *Nut9localPos = new G4ThreeVector(boltRad*cos(8.5*boltangle), 
  													boltRad*sin(8.5*boltangle), 1.2258*25.4*mm);
  ...
  *Nut9affine*=*assemAffine;  
  ...
  G4ThreeVector *Nut10localPos = new G4ThreeVector(boltRad*cos(9.5*boltangle), 
  													boltRad*sin(9.5*boltangle), 1.2258*25.4*mm);
  ...
  *Nut10affine*=*assemAffine;  
  ...
  G4ThreeVector *Nut11localPos = new G4ThreeVector(boltRad*cos(10.5*boltangle), 
  													boltRad*sin(10.5*boltangle), 1.2258*25.4*mm);
  ...
  *Nut11affine*=*assemAffine;  
  ...
  G4ThreeVector *Nut12localPos = new G4ThreeVector(boltRad*cos(11.5*boltangle), 
  													boltRad*sin(11.5*boltangle), 1.2258*25.4*mm);
