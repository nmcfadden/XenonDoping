...
//      
// CLASS IMPLEMENTATION:  MJDemoThermosyphonTube.cc
//
//---------------------------------------------------------------------------//
/**
 * SPECIAL NOTES:
...
#include "mjdemonstrator/MJDemoThermosyphonTube.hh"
...
MJDemoThermosyphonTube::MJDemoThermosyphonTube(G4String partName, G4String serialNumber) :
  MJVDemoPart(partName, serialNumber, "ThermosyphonTubeDwg", "Copper-EF")
{;}

MJDemoThermosyphonTube::MJDemoThermosyphonTube(const MJDemoThermosyphonTube & rhs) : 
  MJVDemoPart(rhs)
{;}

MJDemoThermosyphonTube::~MJDemoThermosyphonTube()
{;}

G4LogicalVolume* MJDemoThermosyphonTube::ConstructPart()
{
  ...
  if (pVol == NULL){
    G4Tubs* tube = new G4Tubs("tube", 0.55*25.4*mm, 0.71*25.4*mm, 17.788*25.4*mm, 0, 2*pi); 
