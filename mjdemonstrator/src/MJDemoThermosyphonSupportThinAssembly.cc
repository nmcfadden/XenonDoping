...
//      
// CLASS IMPLEMENTATION:  MJDemoThermosyphonSupportThinAssembly.cc
//
//---------------------------------------------------------------------------//
/**
 * SPECIAL NOTES:
...
MJDemoThermosyphonSupportThinAssembly::MJDemoThermosyphonSupportThinAssembly(G4String fName, G4String serialNumber) :
  MJVDemoAssembly(fName, serialNumber, "MJ80-11-142-R001")
{
  fFemaleHalfPtr = new MJDemoThermosyphonSupportThinHalfFemale(fName+"_FemaleHalf_001", "867-5309");
  fMaleHalfPtr = new MJDemoThermosyphonSupportThinHalfMale(fName+"_MaleHalf_001", "867-5309");
...
MJDemoThermosyphonSupportThinAssembly::MJDemoThermosyphonSupportThinAssembly(const MJDemoThermosyphonSupportThinAssembly & rhs) : 
  MJVDemoAssembly(rhs)
{
  fFemaleHalfPtr = new MJDemoThermosyphonSupportThinHalfFemale(fName+"_FemaleHalf_001", "867-5309");
  fMaleHalfPtr = new MJDemoThermosyphonSupportThinHalfMale(fName+"_MaleHalf_001", "867-5309");
...
MJDemoThermosyphonSupportThinAssembly::~MJDemoThermosyphonSupportThinAssembly()
{
...
void MJDemoThermosyphonSupportThinAssembly::Place(G4ThreeVector* assemPosition, 
                G4RotationMatrix* assemRotation, G4LogicalVolume* motherLogical)
{
  ...
  *MaleHalfaffine*=*assemAffine;
  ...
  G4ThreeVector *CliplocalPos = new G4ThreeVector(eps, 0, -2.6*mm);
  ...
  *Clipaffine*=*assemAffine;
  ...
  G4ThreeVector *ShortCliplocalPos = new G4ThreeVector(-eps, 0, -2.6*mm);
  ...
  *ShortClipaffine*=*assemAffine;
  ...
  G4ThreeVector *Screw01localPos = new G4ThreeVector(-31.61*mm, 5.007*mm+eps, -3.43*mm);
  ...
  *Screw01affine*=*assemAffine;
  ...
  G4ThreeVector *Screw02localPos = new G4ThreeVector(-31.61*mm, -5.007*mm-eps, -3.43*mm);
  ...
  *Screw02affine*=*assemAffine;
  ...
  G4ThreeVector *Screw03localPos = new G4ThreeVector(32.004*mm, 5.007*mm+eps, -3.43*mm);
  ...
  *Screw03affine*=*assemAffine;
  ...
  G4ThreeVector *Screw04localPos = new G4ThreeVector(32.004*mm, -5.007*mm-eps, -3.43*mm);
