...
//      
// CLASS IMPLEMENTATION:  MJProtoThermalShieldAssembly.cc
//
//---------------------------------------------------------------------------//
/**
 * SPECIAL NOTES:
 ...
 *Same as MJDemoThermalShieldAssembly but uses MJProto832Screw (made of SS) rather 
 * than the MJDemo832Screw (made of EFCu)
 */
// 
//---------------------------------------------------------------------------//
...
MJProtoThermalShieldAssembly::MJProtoThermalShieldAssembly(G4String fName, G4String serialNumber) :
  MJVDemoAssembly(fName, serialNumber, "ThermalShield")
{
  ...
  fScrew1Ptr = new MJProto832Screw(fName+"_8_32x0.625Screw_001", "867-5309", 0.625*25.4);
  fScrew2Ptr = new MJProto832Screw(fName+"_8_32x0.625Screw_002", "867-5309", 0.625*25.4);
  fScrew3Ptr = new MJProto832Screw(fName+"_8_32x0.625Screw_003", "867-5309", 0.625*25.4);
  fScrew4Ptr = new MJProto832Screw(fName+"_8_32x0.625Screw_004", "867-5309", 0.625*25.4);
  fScrew5Ptr = new MJProto832Screw(fName+"_8_32x0.625Screw_005", "867-5309", 0.625*25.4);
  fScrew6Ptr = new MJProto832Screw(fName+"_8_32x0.625Screw_006", "867-5309", 0.625*25.4);  
  fScrew7Ptr = new MJProto832Screw(fName+"_8_32x0.625Screw_007", "867-5309", 0.625*25.4);    
  fScrew8Ptr = new MJProto832Screw(fName+"_8_32x0.625Screw_008", "867-5309", 0.625*25.4);    
  fSideScrew1Ptr = new MJProto832Screw(fName+"_8_32x0.25Screw_001", "867-5309", 0.25*25.4);
  fSideScrew2Ptr = new MJProto832Screw(fName+"_8_32x0.25Screw_002", "867-5309", 0.25*25.4);
  fSideScrew3Ptr = new MJProto832Screw(fName+"_8_32x0.25Screw_003", "867-5309", 0.25*25.4);
  fSideScrew4Ptr = new MJProto832Screw(fName+"_8_32x0.25Screw_004", "867-5309", 0.25*25.4);
  fSideScrew5Ptr = new MJProto832Screw(fName+"_8_32x0.25Screw_005", "867-5309", 0.25*25.4);
  fSideScrew6Ptr = new MJProto832Screw(fName+"_8_32x0.25Screw_006", "867-5309", 0.25*25.4);
}

MJProtoThermalShieldAssembly::MJProtoThermalShieldAssembly(const MJProtoThermalShieldAssembly & rhs) : 
  MJVDemoAssembly(rhs)
{
  fCanPtr = new MJDemoThermalShieldCan(fName+"_ThermalShieldCan_001", "867-5309");  
  fAnnulusPtr = new MJDemoThermalShieldAnnulus(fName+"_ThermalShieldAnnulus_001", "867-5309");  
...
MJProtoThermalShieldAssembly::~MJProtoThermalShieldAssembly()
{
  delete fCanPtr;
  delete fAnnulusPtr;
  delete fSupport1Ptr;
...
void MJProtoThermalShieldAssembly::Place(G4ThreeVector* assemPosition, 
                G4RotationMatrix* assemRotation, G4LogicalVolume* motherLogical)
{
  ...
  *shieldWedge3affine*=*assemAffine;  
  ...
  G4double screwZposition = 0.6*25.4*mm+eps; 
