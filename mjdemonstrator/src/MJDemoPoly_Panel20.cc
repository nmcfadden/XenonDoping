...
MJDemoPoly_Panel20::MJDemoPoly_Panel20(G4String partName, G4String serialNumber) :
  MJVDemoPart(partName, serialNumber, "PolySouthWall_ChillerOuter", serialNumber)
{;}

MJDemoPoly_Panel20::MJDemoPoly_Panel20(const MJDemoPoly_Panel20 & rhs) : 
  MJVDemoPart(rhs)
{;}

MJDemoPoly_Panel20::~MJDemoPoly_Panel20()
{;}

G4LogicalVolume* MJDemoPoly_Panel20::ConstructPart()
{
  ...
  if (pVol == NULL){
	  ...
	  G4SubtractionSolid* box2 = new G4SubtractionSolid("box2", box1, cutout1, 0, G4ThreeVector(-76.835*mm, 0, -680.72*mm));
		G4Box* cutout2 = new G4Box("cutout2",  154.178*mm, 25.5*mm, 149.225*mm);    	//12.14x11.75
    G4SubtractionSolid* box3 = new G4SubtractionSolid("box3", box2, cutout2, 0, G4ThreeVector(-121.285*mm, 0, -200.787*mm));
		G4Box* cutout3 = new G4Box("cutout3", 101.6*mm, 25.5*mm, 50.8*mm);    	//8 x4 in 3rd panel from above
  	G4SubtractionSolid* poly_Panel20 = new G4SubtractionSolid("poly_Panel20", box3, cutout3, 0, G4ThreeVector(0.889*mm, 0, 787.4*mm));
	

    G4VisAttributes* greenVisAtt = new G4VisAttributes(G4Colour(0.0, 1.0, 0.0)); // green
    greenVisAtt->SetForceWireframe( false );
    G4Material *material = G4Material::GetMaterial(this->GetMaterial());
    pVol = new G4LogicalVolume(poly_Panel20, material, logicalName);
