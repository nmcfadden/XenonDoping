 ...
 * FIRST SUBMISSION: 12-14-2010
 * 
 * REVISION:
 * 01-25-2011, Updated positions of holes due to movement of cryostat.  
 * 01-05-2011, Updated dimensions due to slight redesign, M. Kidd
 * 12-07-2010, Created, M. Kidd
 * 09-11-2017, Adjusted Overfloor, R. Massarczyk
 */
//---------------------------------------------------------------------------//
//
...
MJDemoMuonVetoAssembly::MJDemoMuonVetoAssembly(G4String fName, G4String serialNumber) :
  MJVDemoAssembly(fName, serialNumber, "MuonVeto")
{
...
MJDemoMuonVetoAssembly::MJDemoMuonVetoAssembly(const MJDemoMuonVetoAssembly & rhs) : 
  MJVDemoAssembly(rhs)
{
  G4double in2mm = 25.4;  //inches to millimeters
...
MJDemoMuonVetoAssembly::~MJDemoMuonVetoAssembly()
{
...
void MJDemoMuonVetoAssembly::Place(G4ThreeVector* assemPosition, 
...
//cross arm panels
  ...
  *shortThroughTopAffine*=*assemAffine;  
  ...
  fShortThroughTopPtr->Place(shortThroughTopGlobalPos, shortThroughTopGlobalRot, motherLogical);
  ...
  *shortThroughBottomAffine*=*assemAffine;  
  ...
  fShortThroughBottomPtr->Place(shortThroughBottomGlobalPos, shortThroughBottomGlobalRot, motherLogical);
  ...
  *shortThroughLeftAffine*=*assemAffine;  
  ...
  fShortThroughLeftPtr->Place(shortThroughLeftGlobalPos, shortThroughLeftGlobalRot, motherLogical);
  ...
  *shortThroughRightAffine*=*assemAffine;  
  ...
  fShortThroughRightPtr->Place(shortThroughRightGlobalPos, shortThroughRightGlobalRot, motherLogical);
  ...
  *longThroughTopAffine*=*assemAffine;  
  ...
  fLongThroughTopPtr->Place(longThroughTopGlobalPos, longThroughTopGlobalRot, motherLogical);
  ...
  *longThroughBottomAffine*=*assemAffine;  
  ...
  fLongThroughBottomPtr->Place(longThroughBottomGlobalPos, longThroughBottomGlobalRot, motherLogical);
  ...
  *longThroughRightAffine*=*assemAffine;  
  ...
  fLongThroughRightPtr->Place(longThroughRightGlobalPos, longThroughRightGlobalRot, motherLogical);
  ...
  *longThroughLeftAffine*=*assemAffine;  
  ...
  fLongThroughLeftPtr->Place(longThroughLeftGlobalPos, longThroughLeftGlobalRot, motherLogical);
...
//solid panels
  ...
  *shortSolidTopAffine*=*assemAffine;  
  ...
  fShortSolidTopPtr->Place(shortSolidTopGlobalPos, shortSolidTopGlobalRot, motherLogical);
  ...
  *shortSolidBottomAffine*=*assemAffine;  
  ...
  fShortSolidBottomPtr->Place(shortSolidBottomGlobalPos, shortSolidBottomGlobalRot, motherLogical);
  ...
  *shortSolidLeftAffine*=*assemAffine;  
  ...
  fShortSolidLeftPtr->Place(shortSolidLeftGlobalPos, shortSolidLeftGlobalRot, motherLogical);
  ...
  *shortSolidRightAffine*=*assemAffine;  
  ...
  fShortSolidRightPtr->Place(shortSolidRightGlobalPos, shortSolidRightGlobalRot, motherLogical);
  ...
  *longSolidTopAffine*=*assemAffine;  
  ...
  fLongSolidTopPtr->Place(longSolidTopGlobalPos, longSolidTopGlobalRot, motherLogical);
  ...
  *longSolidBottomAffine*=*assemAffine;  
  ...
  fLongSolidBottomPtr->Place(longSolidBottomGlobalPos, longSolidBottomGlobalRot, motherLogical);
  ...
  *longSolidLeftAffine*=*assemAffine;  
  ...
  fLongSolidLeftPtr->Place(longSolidLeftGlobalPos, longSolidLeftGlobalRot, motherLogical);
  ...
  *longSolidRightAffine*=*assemAffine;  
  ...
  fLongSolidRightPtr->Place(longSolidRightGlobalPos, longSolidRightGlobalRot, motherLogical);
  ...
  *topOuter1Affine*=*assemAffine;  
  ...
  fTopOuter1Ptr->Place(topOuter1GlobalPos, topOuter1GlobalRot, motherLogical);
  ...
  *topOuter2Affine*=*assemAffine;  
  ...
  fTopOuter2Ptr->Place(topOuter2GlobalPos, topOuter2GlobalRot, motherLogical);
  ...
  *topInner1Affine*=*assemAffine;  
  ...
  fTopInner1Ptr->Place(topInner1GlobalPos, topInner1GlobalRot, motherLogical);
  ...
  *topInner2Affine*=*assemAffine;  
  ...
  fTopInner2Ptr->Place(topInner2GlobalPos, topInner2GlobalRot, motherLogical);
...
// moved over floor 88.9*mm in x, -70 mm in y, +50.8 in z, to avoid overlap with poly west wall which is more accurate 

  G4double op_fr_h = in2mm*18.65*mm;
  G4double overFloorzOffset = 1.66*in2mm*mm;
  G4double overFloorzSpacing = 8.0*in2mm*mm;
  
  G4ThreeVector *overFloorAssmlocalPos1 = new G4ThreeVector(88.9*mm, -70*mm, -2.0*op_fr_h - overFloorzOffset + 50.8*mm);
  ...
  *overFloorAssmAffine1*=*assemAffine;  
  ...
  fOverFloorAssmPtr1->Place(overFloorAssmglobalPos1, overFloorAssmglobalRot1, motherLogical);
  delete overFloorAssmlocalPos1;
  delete overFloorAssmlocalRot1;
  delete overFloorAssmAffine1;
  
  G4ThreeVector *overFloorAssmlocalPos2 = new G4ThreeVector(88.9*mm, -70*mm, -2.0*op_fr_h-overFloorzOffset-overFloorzSpacing + 50.8*mm);
  ...
  *overFloorAssmAffine2*=*assemAffine;  
  ...
  fOverFloorAssmPtr2->Place(overFloorAssmglobalPos2, overFloorAssmglobalRot2, motherLogical);
