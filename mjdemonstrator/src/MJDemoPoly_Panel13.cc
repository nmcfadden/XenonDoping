...
MJDemoPoly_Panel13::MJDemoPoly_Panel13(G4String partName, G4String serialNumber) :
  MJVDemoPart(partName, serialNumber, "PolyWestWall_SmallOuterUpper", serialNumber)
{;}

MJDemoPoly_Panel13::MJDemoPoly_Panel13(const MJDemoPoly_Panel13 & rhs) : 
  MJVDemoPart(rhs)
{;}

MJDemoPoly_Panel13::~MJDemoPoly_Panel13()
{;}

G4LogicalVolume* MJDemoPoly_Panel13::ConstructPart()
{
  ...
  if (pVol == NULL){
		G4Box* poly_Panel13 = new G4Box("poly_Panel13", 25.4*mm, 777.875*mm, 571.5*mm);  // 61.25 x (5x9)
	

    G4VisAttributes* greenVisAtt = new G4VisAttributes(G4Colour(0.0, 1.0, 0.0)); // green
    greenVisAtt->SetForceWireframe( false );
    G4Material *material = G4Material::GetMaterial(this->GetMaterial());
    pVol = new G4LogicalVolume(poly_Panel13, material, logicalName);
