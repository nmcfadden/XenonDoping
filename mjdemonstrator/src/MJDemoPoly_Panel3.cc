...
MJDemoPoly_Panel3::MJDemoPoly_Panel3(G4String partName, G4String serialNumber) :
  MJVDemoPart(partName, serialNumber, "PolyModule2Roof", serialNumber)
{;}

MJDemoPoly_Panel3::MJDemoPoly_Panel3(const MJDemoPoly_Panel3 & rhs) : 
  MJVDemoPart(rhs)
{;}

MJDemoPoly_Panel3::~MJDemoPoly_Panel3()
{;}

G4LogicalVolume* MJDemoPoly_Panel3::ConstructPart()
{
  ...
  if (pVol == NULL){
		G4Box* poly_Panel3 = new G4Box("poly_Panel3", 641.35*mm, 1054.1*mm, 25.4*mm);  //rawPanel  50.5 x 83
	

    G4VisAttributes* greenVisAtt = new G4VisAttributes(G4Colour(0.0, 1.0, 0.0)); // green
    greenVisAtt->SetForceWireframe( false );
    G4Material *material = G4Material::GetMaterial(this->GetMaterial());
    pVol = new G4LogicalVolume(poly_Panel3, material, logicalName);
