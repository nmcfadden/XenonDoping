...
//      
// CLASS IMPLEMENTATION:  MJDemoThermosyphonSupportThinHalfFemale.cc
//
//---------------------------------------------------------------------------//
/**
 * SPECIAL NOTES:
...
#include "mjdemonstrator/MJDemoThermosyphonSupportThinHalfFemale.hh"
...
MJDemoThermosyphonSupportThinHalfFemale::MJDemoThermosyphonSupportThinHalfFemale(G4String partName, G4String serialNumber) :
  MJVDemoPart(partName, serialNumber, "MJ80-11-136-R002", "Vespel")
{;}

MJDemoThermosyphonSupportThinHalfFemale::MJDemoThermosyphonSupportThinHalfFemale(const MJDemoThermosyphonSupportThinHalfFemale & rhs) : 
  MJVDemoPart(rhs)
{;}

MJDemoThermosyphonSupportThinHalfFemale::~MJDemoThermosyphonSupportThinHalfFemale()
{;}

G4LogicalVolume* MJDemoThermosyphonSupportThinHalfFemale::ConstructPart()
{
  ...
  if (pVol == NULL){
    ...
    G4Tubs* mainCyl = new G4Tubs("Main Cyl",33.274/2*mm, 70.18/2*mm, 3.81/2*mm, 0, M_PI);
