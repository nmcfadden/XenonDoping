...
//      
// CLASS IMPLEMENTATION:  MJDemoCableGuideSnapClipThermosyphon.cc
//
//---------------------------------------------------------------------------//
/**
 * SPECIAL NOTES:
...
MJDemoCableGuideSnapClipThermosyphon::MJDemoCableGuideSnapClipThermosyphon(G4String partName, G4String serialNumber) :
  MJVDemoPart(partName, serialNumber, "MJ80-11-138-R001", "Vespel")
{;}

MJDemoCableGuideSnapClipThermosyphon::MJDemoCableGuideSnapClipThermosyphon(const MJDemoCableGuideSnapClipThermosyphon & rhs) : 
  MJVDemoPart(rhs)
{;}

MJDemoCableGuideSnapClipThermosyphon::~MJDemoCableGuideSnapClipThermosyphon()
{;}

G4LogicalVolume* MJDemoCableGuideSnapClipThermosyphon::ConstructPart()
{
  ...
  if (pVol == NULL){
    ...
    G4Tubs* mainCyl = new G4Tubs("Main Cyl", 66.294/2*mm, 73.406/2*mm, 1.27/2*mm, 0, M_PI);
    G4Tubs* mainCyl2a = new G4Tubs("Main Cyl 2a", 70.36/2*mm, 73.406/2*mm, 6.655/2*mm, 0, 22.044*deg);
    G4Tubs* mainCyl2b = new G4Tubs("Main Cyl 2b", 70.36/2*mm, 73.406/2*mm, 6.655/2*mm, (22.044+13.273)*deg, 108.088*deg);
    G4Tubs* mainCyl2c = new G4Tubs("Main Cyl 2c", 70.36/2*mm, 73.406/2*mm, 6.655/2*mm, (180-22.044)*deg, 22.044*deg);
    ...
    partUnion = new G4UnionSolid("Part Union", partUnion, mainCyl2b, rotN, G4ThreeVector(0, 0, (1.27+6.655)/2*mm));
    partUnion = new G4UnionSolid("Part Union", partUnion, mainCyl2c, rotN, G4ThreeVector(0, 0, (1.27+6.655)/2*mm));
    ...
    MGLog(debugging) << "Created Cable Guide Snap Clip Thermosyphon Logical" << endlog;
  }
  else  MGLog(debugging) << "Using pre-existing Cable Guide Snap Clip Thermosyphon Logical" << endlog; 
  return pVol;
}  
