...
MJDemoPoly_Panel11::MJDemoPoly_Panel11(G4String partName, G4String serialNumber) :
  MJVDemoPart(partName, serialNumber, "PolyWestWall_SmallInnerUpper", serialNumber)
{;}

MJDemoPoly_Panel11::MJDemoPoly_Panel11(const MJDemoPoly_Panel11 & rhs) : 
  MJVDemoPart(rhs)
{;}

MJDemoPoly_Panel11::~MJDemoPoly_Panel11()
{;}

G4LogicalVolume* MJDemoPoly_Panel11::ConstructPart()
{
  ...
  if (pVol == NULL){
		G4Box* poly_Panel11 = new G4Box("poly_Panel11", 25.4*mm, 701.675*mm, 571.5*mm);  // 55.25 x (9*5)
	

    G4VisAttributes* greenVisAtt = new G4VisAttributes(G4Colour(0.0, 1.0, 0.0)); // green
    greenVisAtt->SetForceWireframe( false );
    G4Material *material = G4Material::GetMaterial(this->GetMaterial());
    pVol = new G4LogicalVolume(poly_Panel11, material, logicalName);
