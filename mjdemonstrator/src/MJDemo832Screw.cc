...
//      
// CLASS IMPLEMENTATION:  MJDemo832Screw.cc
//
//---------------------------------------------------------------------------//
/**
 * SPECIAL NOTES:
...
MJDemo832Screw::MJDemo832Screw(G4String partName, G4String serialNumber, 
								G4double length) :
  MJVDemoPart(partName, serialNumber, "8-32", "Copper-EF"), 
  fScrewLength(length*mm)
{;}

MJDemo832Screw::MJDemo832Screw(const MJDemo832Screw & rhs) : 
  MJVDemoPart(rhs), fScrewLength(rhs.fScrewLength)
{;}

MJDemo832Screw::~MJDemo832Screw()
{;}

G4LogicalVolume* MJDemo832Screw::ConstructPart()
{
...
/*  THIS IS CODE FOR A SLOTTED SCREW - OBSOLETE
