...
LGND_200_StringAssembly::LGND_200_StringAssembly(G4String fName, G4String serialNumber, size_t crystalNum) :
                ...
                G4RotationMatrix* assemRotation, G4LogicalVolume* motherLogical)
{
  ...
  for(size_t i = 0; i<fCrystalNum; i++){
    ...
    fDetUnitPtr[i] = new LGND_200_DetUnitAssembly(DetUnitAssemblyName, crysAssemList.at(i));
    if (i == 0){
  ...
  fMiniShroudPtr = new LGND_MiniShroud(fName + "_MiniShroudTeflon_001", "867-5309", stringLength+10.0*mm,"Nylon");
  fMiniShroudInnerTPBptr = new LGND_MiniShroud(fName + "_MiniShroudTPBInner_001", "00011-0004",stringLength+10.0*mm,"TPB");
  fMiniShroudOuterTPBptr = new LGND_MiniShroud(fName + "_MiniShroudTPBOuter_001", "00011-0003",stringLength+10.0*mm,"TPB");
