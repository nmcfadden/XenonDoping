...
LGND_FiberCladding::LGND_FiberCladding(G4String partName, G4String serialNumber, G4double length) :
  LGND_Part(partName, serialNumber, "LGND_FiberCladding", "PMMA"),
  fLength(length*mm)
{;}
LGND_FiberCladding::LGND_FiberCladding(G4String partName, G4String serialNumber, G4double length,G4String shape,G4String material) :
  LGND_Part(partName, serialNumber, "LGND_FiberCladding",material),
  fLength(length*mm),
  fShape(shape)
{
...
LGND_FiberCladding::LGND_FiberCladding(G4String partName, G4String serialNumber) :
  LGND_Part(partName, serialNumber, "LGND_FiberCladding", "PMMA")
{;}

LGND_FiberCladding::LGND_FiberCladding(const LGND_FiberCladding & rhs) :
  LGND_Part(rhs)
{;}

LGND_FiberCladding::~LGND_FiberCladding()
{;}

G4LogicalVolume* LGND_FiberCladding::BuildLogicalVolume()
{
