 ...
 *
 * CLASS DECLARATION:  LGND_LMFE.hh
 *
 *---------------------------------------------------------------------------//
 *
 * DESCRIPTION:
...
#ifndef _LGND_LMFE_HH
#define _LGND_LMFE_HH
...
class LGND_LMFE: public LGND_Part
{

public:
  LGND_LMFE(G4String, G4String);
  LGND_LMFE(const LGND_LMFE &);
  ~LGND_LMFE();
