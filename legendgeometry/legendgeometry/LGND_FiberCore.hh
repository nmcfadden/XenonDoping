 ...
 *
 * CLASS DECLARATION:  LGND_FiberCore.hh
 *
 *---------------------------------------------------------------------------//
 *
 * DESCRIPTION:
...
#ifndef _LGND_FIBERCORE_HH
#define _LGND_FIBERCORE_HH
...
class LGND_FiberCore: public LGND_Part
{

public:
  LGND_FiberCore(G4String, G4String, G4double,G4String);
  LGND_FiberCore(G4String, G4String, G4double);
  LGND_FiberCore(G4String, G4String);
  LGND_FiberCore(const LGND_FiberCore &);
  ~LGND_FiberCore();
